#!/usr/bin/env python3
"""
ENHANCED LOAN VIEWER - Fixed for Windows date formatting
Clean and simple like the original
"""
...
async def view_loan(loan_number: str):
    ...
    # Date range - Windows compatible formatting
...
if __name__ == "__main__":
    ...
    print("\nFixed for Windows - no date formatting issues!")
