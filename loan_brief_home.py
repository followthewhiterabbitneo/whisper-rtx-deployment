#!/usr/bin/env python3
"""
LOAN BRIEF HOME - Simple web interface with clickable links
No typing URLs!
"""
...
def home():
    ...
    cursor.execute("""
        SELECT DISTINCT
            JSON_UNQUOTE(JSON_EXTRACT(loan_numbers, '$[0]')) as loan_number,
            COUNT(*) as mentions,
            MAX(created_at) as last_seen
        FROM call_transcripts_v2
        WHERE loan_numbers != '[]'
        AND loan_numbers NOT LIKE '%,%'
    ...
    html += """
            ...
            <div class="card" style="margin-top: 20px;">
                <h2>🔗 Quick Links</h2>
                <a href="/api/docs" class="loan-link">📚 API Documentation</a>
                <a href="/analytics" class="loan-link">📊 Analytics Dashboard</a>
