#!/usr/bin/env python3
"""
First principles test - Deep dive into ONE loan
"""
...
def test_one_loan():
    ...
    # Check how many other loans this party handles
    cursor.execute("""
        SELECT COUNT(DISTINCT JSON_EXTRACT(ct.loan_numbers, '$[*]')) as other_loans
        FROM call_transcripts_v2 ct
        JOIN orktape t ON ct.orkuid = t.orkUid
    ...
    result = cursor.fetchone()
    print(f"This party handles {result['other_loans']} different loans total")
