#!/usr/bin/env python3
"""
Legal Summary Generator using Llama 3 8B Instruct - GUARANTEED TO WORK!
This uses your Llama-3-8B-Instruct model which is compatible with all llama-cpp-python versions
"""
...
def generate_summary(transcript_path):
    ...
    print(f"""
╔══════════════════════════════════════════════════════════════╗
║          LLAMA 3 8B LEGAL SUMMARY GENERATOR                  ║
╚══════════════════════════════════════════════════════════════╝
""")
    ...
    try:
        ...
        print("   Using RTX 4090 GPU acceleration...")
    ...
    try:
        ...
        # Text version
        output_file = output_dir / f"{base_name}_llama3_legal_summary.txt"
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write(f"Legal Brief Summary - Llama 3 8B Instruct\n")
        ...
        # HTML version
        html_file = output_dir / f"{base_name}_llama3_legal_summary.html"
...
def main():
    if len(sys.argv) > 1:
        ...
        print("Usage: python llama3_legal_summary.py <transcript_path>")
        print("\nExample:")
        print('python llama3_legal_summary.py "C:\\transcripts\\2025\\06\\02\\20250602_115752_IPBU.txt"')
        return
